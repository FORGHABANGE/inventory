...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (!$product) {
            ...
            $errors[] = "Insufficient stock. Available quantity: {$product['quantity']}.";
        }
    }
    ...
    <div class="card">
        ...
        <form method="POST">
            ...
            <div style="display:flex; gap:12px;">
                <button type="submit" class="btn"><i class="bi bi-save"></i> Remove Stock</button>
                <a href="stock_movements.php" class="btn secondary" style="text-decoration:none;"><i class="bi bi-arrow-left"></i> Back</a>
            </div>
        </form>
    </div>
</div>
