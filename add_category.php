...
<input type="text" name="name" placeholder="Enter category name" value="<?= htmlspecialchars($_POST['name'] ?? '') ?>" required>
<label>Description</label>
<textarea name="description" rows="3"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
<div style="display:flex; gap:12px; margin-top:14px;">
<button type="submit"><i class="bi bi-plus-circle"></i> Add Category</button>
